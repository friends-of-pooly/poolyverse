            ...
            <ul className="flex justify-center items-center flex-wrap text-sm">
              ...
              <li className="ml-3">
                ...
                >
                  <button
                    type="button"
                    className="text-white font-bold bg-gradient-to-br from-purple-400 to-purple-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
                  >
                    Enter the PoolyVerse
                  </button>
                </Link>
              </li>
            </ul>
